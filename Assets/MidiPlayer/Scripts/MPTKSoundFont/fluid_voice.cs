            ...
            switch (igen)
            {
                ...
                case (int)fluid_gen_type.GEN_PAN:
                    ...
                    if (synth.MPTK_CorePlayer)
                    {
                        ...
                        //if (synth.MPTK_EnablePanChange)
                        //{
                        //    amp_left = fluid_conv.fluid_pan(pan, true) * mptkChannel.volume; 
                        //    amp_right = fluid_conv.fluid_pan(pan, false) * mptkChannel.volume;
                        //}
                        //else
                        //{
                        //    amp_left = mptkChannel.volume; 
                        ...
                        if (synth.VerboseCalcGen)
                            Debug.LogFormat("Calc {0} synth.gain={1:0.00} pan={2:0.00} amp_left={3:0.00} amp_right={4:0.00} preset={5}",
                                (fluid_gen_type)igen, synth.gain, pan, amp_left, amp_right, midiChannel.preset.Num);
                    }
                    break;
